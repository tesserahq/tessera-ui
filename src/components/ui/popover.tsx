    ...
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          ...
          ring-foreground/10 flex flex-col gap-2.5 rounded-lg p-2.5 text-sm shadow-md ring-1
          duration-100 z-50 w-72 origin-(--radix-popover-content-transform-origin) outline-hidden`,
          className
        )}
        {...props}
      />

...
const DeleteConfirmation = React.forwardRef<DeleteConfirmationHandle, DeleteConfirmationProps>(
  ({ defaultConfig }, ref) => {
    const [open, setOpen] = React.useState(false)
    const [config, setConfig] = React.useState<DeleteConfirmationConfig>(
      defaultConfig || {
        title: '',
        description: '',
        onDelete: () => {},

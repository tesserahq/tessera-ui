...
<Meta title="Information/DeleteConfirmation" />
  ...
  rows={[
    {
      ...
      default: '-',
      description: 'Default configuration for the dialog',
    },
    {
      name: 'ref',
      required: true,
      ...
      default: '-',
      description: 'Ref object to control the dialog imperatively',
    },
  ]}
/>
  ...
  rows={[
    {
      ...
      type: 'string',
      default: '-',
      description: 'Title text displayed in the dialog',
    },
    {
      name: 'description',
      required: true,
    ...
    },
    {
      ...
      default: '-',
      description: 'Function called when user confirms deletion (can be async)',
    },
    {
      name: 'isLoading',
      required: false,
      type: 'boolean',
      default: '-',
      description: 'Whether the delete operation is in progress (shows spinner)',
    },
  ]}
/>
  ...
  rows={[
    {
      name: 'open',
      required: false,
      type: '(config?: DeleteConfirmationConfig) => void',
      default: '-',
      description:
        'Opens the dialog with optional configuration. If config is provided, updates the dialog configuration before opening.',
    },
    {
      name: 'close',
      required: false,
    ...
    },
    {
      name: 'updateConfig',
      required: false,
      type: '(updates: Partial<DeleteConfirmationConfig>) => void',
      default: '-',
      description:

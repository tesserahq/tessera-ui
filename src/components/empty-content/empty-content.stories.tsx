  ...
  args: {
    ...
    children: (
      <div className="flex gap-3">
        <Button onClick={() => console.log('Import clicked')}>Import Data</Button>
        <Button variant="outline" onClick={() => console.log('Start fresh clicked')}>
          Start Fresh
        </Button>
      </div>
    ),
...
export const LongDescription: Story = {
  args: {
    ...
    children: (
      <Button variant="outline" onClick={() => console.log('Clear filters clicked')}>
        Clear Filters
      </Button>
    ),
  },
